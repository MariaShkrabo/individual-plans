...
import { APPLICATION_ROUTES, FACULTIES } from "../../../shared/constants";
...
import { GET_CATHEDRAS, GET_FACULTIES } from "../../../shared/api/requests";
...
const Register = () => {
  ...
  const cathedraId = watch("cathedra");
  const [faculties, setFaculties] = useState([]);
  const [cathedras, setCathedras] = useState([]);

  const register = async (formData) => {
    //dispatch(showSuccess(t('notifications.activationLink')));
