...
import classes from "./organizational-and-methodical-work.module.scss";
...
const OrganizationalAndMethodicalWorks = () => {
  const name = "organizational_and_methodical_works";
...
export default OrganizationalAndMethodicalWorks;
