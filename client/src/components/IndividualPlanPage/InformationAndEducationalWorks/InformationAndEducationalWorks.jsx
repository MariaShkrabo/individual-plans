...
import classes from "./information_and_educational_work.module.scss";
...
import {
  ...
  UPDATE_IND_PLAN_INF_ED_HOURS,
  UPDATE_INFORMATION_AND_EDUCATIONAL_DATA,
} from "../../../shared/api/requests";
import { setFields } from "../../../shared/functions/setFields";
import { showSuccess } from "../../../redux/Actions";

const InformationAndEducationalWorks = () => {
  const name = "information_and_educational_works";
  ...
  const save = async (formData) => {
    const data = { ...formData };
    await request(
      UPDATE_INFORMATION_AND_EDUCATIONAL_DATA(me.id, setFields(data, null))
    );
    await request(UPDATE_IND_PLAN_INF_ED_HOURS(me.id));
...
export default InformationAndEducationalWorks;
